...
function removeUnreferencedSchemas(apiDefinition: OpenApiDocument, schemas: OpenApiDocument): void {
 ...
 */
export function removeUnusedSchemasTransformer(apiDefinition: OpenApiDocument): void {
  const {
    components: { schemas },
  } = apiDefinition;
