...
const removeReadmeFromSchema = (yaml: string | Buffer) => transformSchema(yaml, [removeFieldTransformer('x-readme')]);
const removeAdditionalPropertiesFalseFromSchema = (yaml: string | Buffer) =>
