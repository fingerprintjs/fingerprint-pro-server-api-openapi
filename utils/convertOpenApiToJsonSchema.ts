...
export function convertOpenApiToJsonSchema(apiDefinition: OpenApiDocument, schemaRef: string): OpenApiDocument {
  return {
    type: 'object',
...
function componentsToDefenitions(components: OpenApiDocument): OpenApiDocument {
