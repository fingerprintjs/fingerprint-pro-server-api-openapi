...
- Add `mlScore` field to the virtualMachine object in v3 ([80be971](https://github.com/fingerprintjs/fingerprint-pro-server-api-openapi/commit/80be97142e08dbc49b206a529508554c4ba87ffa))
...
- **events**: add `simulator` smart signal ([a838050](https://github.com/fingerprintjs/fingerprint-pro-server-api-openapi/commit/a838050aa4db60b502997534a82b41dfbbbf6e6f))
...
- **events-search**: Add `simulator` filter parameter ([a38180b](https://github.com/fingerprintjs/fingerprint-pro-server-api-openapi/commit/a38180b5bc9e8bb961ba3e244d8a1e9a6ff04247))
...
- Add `tampering_confidence` and `tampering_ml_score` fields for `tampering` smart signal. ([301e229](https://github.com/fingerprintjs/fingerprint-pro-server-api-openapi/commit/301e229c75bdde50162ba8371669d62803ab9a52))
...
- Migrate to API v4
  We simplified the API response structure and removed deprecated endpoints. Please refer to the [Migration Guide](https://dev.fingerprint.com/reference/migrating-from-server-api-v3-to-v4#/) for details on the new API structure and available endpoints. ([fe553cb](https://github.com/fingerprintjs/fingerprint-pro-server-api-openapi/commit/fe553cba988198c3b7eaef624d66f4aba9e1d498))
...
- Add APIv3 deprecation notice.
  ...
  If you still use this version, please follow our [migration guide](https://dev.fingerprint.com/reference/migrating-from-server-api-v3-to-v4) to migrate from this deprecated version to the new one. ([3239afe](https://github.com/fingerprintjs/fingerprint-pro-server-api-openapi/commit/3239afe8be6161dc77f822e667a073b75a4cd2d7))
